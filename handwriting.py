...
def decision_trees(images, labels, depths, showimage=False):
    for d in depths:
      print d
...
def random_forests(images, labels, estimators, depths, showimage=False):
  for e in estimators:
    for d in depths:
...
svms(train_images, train_labels, [0.01, 0.1, 1, 10, 100])
random_forests(train_images, train_labels, [1, 10, 50, 100], [2, 4, 8, 16, 32], False)
decision_trees(train_images, train_labels, [2, 4, 8, 16, 32, 64, 128])
